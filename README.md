...
| <a name="input_health_check_command_override"></a> [health\_check\_command\_override](#input\_health\_check\_command\_override) | Option to override a default health check command. | `list(string)` | `[]` | no |
